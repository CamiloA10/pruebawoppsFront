        ...
        .then(function(usuario){
            ...
            if( user){
                cadena='<div class="p-3 mb-2 bg-light text-dark">'+
                    ...
                    '<li class="list-group-item">Apellido: '+user.identificacion+'</li>'+
                    '<li class="list-group-item">Email: '+user.email+'</li>'+
                    '<li class="list-group-item">Direccion: '+user.numeroCuenta+'</li>'+
                    '</ul>';
            }
        ...
        .then(function(usuario){
            ...
            if( user){
                cadena='<div class="p-3 mb-2 bg-light text-dark">'+
                    ...
                    '<input type="text" class="form-control" name="nombre" id="nombre"  required value="'+user.nombre+'"> <br>'+

                    ' <label  for="identificacion" class="form-label" >Identificacion</label>'+
                    ' <input type="text" class="form-control" name="identificacion" id="identificacion" required value="'+user.identificacion+'"><br>'+
...
function verAgregar(){    validaToken()
    ...
    var cadena='<form action="" method="post" id="registrar">'+
        ...
        '<input type="text" class="form-control" name="identificacion" id="identificacion" required><br>'+

        ' <label  for="email" class="form-label" >Email</label>'+
        ' <input type="email" class="form-control" name="email" id="email" required><br>'+

        ' <label  for="clave" class="form-label">clave</label>'+
        ' <input type="password" class="form-control"  name="clave" id="clave" required><br>'+
